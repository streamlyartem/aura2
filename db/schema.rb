...
ActiveRecord::Schema[8.0].define(version: 2026_02_26_234000) do
  ...
  create_table "insales_image_mappings", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "aura_image_id", null: false
    t.bigint "insales_image_id"
    t.bigint "insales_product_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "src_hash"
    t.datetime "last_synced_at"
    t.index ["aura_image_id"], name: "index_insales_image_mappings_on_aura_image_id", unique: true
    t.index ["insales_image_id"], name: "index_insales_image_mappings_on_insales_image_id", unique: true
  ...
  create_table "insales_product_mappings", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "last_synced_at"
    t.bigint "insales_variant_id"
    t.index ["aura_product_id"], name: "index_insales_product_mappings_on_aura_product_id", unique: true
    t.index ["insales_product_id"], name: "index_insales_product_mappings_on_insales_product_id", unique: true
    t.index ["insales_variant_id"], name: "index_insales_product_mappings_on_insales_variant_id"
  end

  create_table "insales_settings", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "login", null: false
    t.string "password", null: false
    t.string "base_url", null: false
    t.string "category_id", null: false
    t.string "image_url_mode", default: "service_url", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "moysklad_sync_runs", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["stop_requested_at"], name: "index_moysklad_sync_runs_on_stop_requested_at"
  end
  ...
  create_table "products", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "color"
    t.string "tone"
    t.boolean "ombre", default: false, null: false
    t.string "code"
    t.jsonb "barcodes", default: []
    t.decimal "purchase_price", precision: 10, scale: 2
    t.decimal "retail_price", precision: 10, scale: 2
    t.decimal "small_wholesale_price", precision: 10, scale: 2
    t.decimal "large_wholesale_price", precision: 10, scale: 2
